...
\input{pre-textual/capa} % Inclui o arquivo da capa
\newpage
...
%\input{textual/capitulo1}
	\input{textual/1-introducao} % Inclui o capítulo de introdução
	\input{textual/2-quarta-feira-de-cinzas}
	%\input{textual/5-palestra}
	%\input{textual/4-reviravoltas}
